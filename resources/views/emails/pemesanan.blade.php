{{-- nama_user, judul, table transaksi, array table keranjang, pivot paket_wahana, pivot paket_destinasi, pivot destinasi --}}
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
    <title>Akun - GoTripJava</title>
</head>
<body>
                                   ...
                                   <tbody>
                                      ...
                                      <tr>
                                         <td class="res-center" style="text-align: left; color: #607080; font-family: 'Nunito', Arial, Sans-serif; font-size: 16px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M2 Paragraph 1" data-size="M2 Paragraph 1" data-max="26" data-min="6">
                                          <table border="0" cellpadding="0" cellspacing="0">
                                             <tr>
                                                <td style="text-align:center" colspan="2">
                                                   Terima kasih telah melakukan pemesanan tiket wisata di GoTripJava, berikut adalah detail pemesanan anda.
                                                </td>
                                             </tr>
                                             <tr>
                                             ...
                                             <tr>
                                                <td style="text-align:center" colspan="2">
                                                   <h4>
                                                   ORDER ID : {{ $content["transaksi"]->order_id }}
                                                   </h4>
                                                </td>
                                             </tr>
                                             <tr>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                   : {{ $content["transaksi"]->nama_pemesan }}
                                                </td>
                                             </tr>
                                             <tr>
                                                <td style="width:250px">
                                                ...
                                                <td>
                                                   : {{ $content["transaksi"]->email_pemesan }}
                                                </td>
                                             </tr>
                                             <tr>
                                                <td style="width:250px">
                                                ...
                                                <td>
                                                   : {{ $content["transaksi"]->no_telp_pemesan }}
                                                </td>
                                             </tr>
                                             <tr>
                                                <td style="width:250px">
                                                ...
                                                <td>
                                                   : {{ $content["transaksi"]->jenisPembayaran()->first()->nama }}
                                                </td>
                                             </tr>
                                             <tr>
                                                <td style="width:250px">
                                                ...
                                                <td>
                                                   : {{ $content["transaksi"]->total_pembayaran }}
                                                </td>
                                             </tr>
                                             <tr>
                                                <td style="width:250px">
                                                ...
                                                <td>
                                                   : {{ $content["transaksi"]->status == "1" ? "Lunas" : "Belum Lunas" }}
                                                </td>
                                             </tr>
                                          </table>
                                          <table style="width:100%">
                                             ...
                                             <tr>
                                                <td>
                                                   <table style="font-size:12px; width:100%; border-color:rgba(0,0,0,0.25)" border="1" cellpadding="5" cellspacing="0">
                                                      <thead>
                                                         <tr>
                                                            <th rowspan="2">
                                                               index
                                                      ...
                                                      <tbody>
                                                         @forelse ($content["transaksi"]->keranjang()->get() as $ker)
                                                         @php
                                                         ...
                                                         @endphp
                                                               <tr>
                                                                  ...
                                                                  <td rowspan="{{ $tinggi }}">{{ $ker->tanggal_kunjungan }}</td>
                                           ...
                                           <tr>
                                              <td>
                                                 <table style="font-size:12px; width:100%; border-color:rgba(0,0,0,0.25)" border="1" cellpadding="5" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                       @forelse ($content["transaksi"]->keranjang()->get() as $ki => $ker)
                                                         @php
                                                           $array_tiket = [];
                                                           $first_tanggal = "";
                                                           $rowspan_tiket = $ker->tikets()->count();
                                                         @endphp
                                                         @foreach($ker->tikets()->get() as $ti => $tiket)
                                                            @if(!in_array($tiket->id,$array_tiket))
                                                               @php
                                                                  $array_tiket[] = $tiket->id;
                                                                  $first_kode_tiket = "";
                                                                  $first_destinasi = "";
                                                                  $rowspan_wahana = $tiket->wahana()->count() != 0 ? $tiket->wahana()->count() : 1;
                                                               @endphp
                                                               @forelse($tiket->wahana()->get() as $wi => $wahana)
                                                               <tr>
                                                                  @if($ker->tanggal_kunjungan != $first_tanggal)
                                                                  @php
                                                                     $first_tanggal = $ker->tanggal_kunjungan;
                                                                  @endphp
                                                                  <td rowspan="{{ $rowspan_tiket*$rowspan_wahana }}">{{ $ker->tanggal_kunjungan }}</td>
                                                                  @endif
                                                                  @if($tiket->kode_tiket != $first_kode_tiket)
                                                                  @php
                                                                     $first_kode_tiket = $tiket->kode_tiket;
                                                                  @endphp
                                                                  <td rowspan="{{ $rowspan_wahana }}">{{ $tiket->kode_tiket }}</td>
                                                                  @endif
                                                                  @if($tiket->destinasi()->first()->nama_destinasi != $first_destinasi)
                                                                  @php
                                                                     $first_destinasi = $tiket->destinasi()->first()->nama_destinasi;
                                                                  @endphp
                                                                  <td rowspan="{{ $rowspan_wahana }}">{{ $tiket->destinasi()->first()->nama_destinasi }}</td>
                                                                  @endif
                                      ...
                                      <tr>
                                         <td class="res-center" style="text-align: center;">
                                            {{-- <a href="{{ $content["tautan"] }}" style="color: #00bb9d; font-family: 'Nunito', Arial, Sans-serif; font-size: 16px; letter-spacing: 0.7px; text-decoration: none; word-break: break-word;" data-color="M2 Link 1" data-size="M2 Link 1" data-max="26" data-min="6">
                                            {{ $content["tautan"] }}
                                            </a> --}}
                                         </td>
                                      </tr>
                                   ...
                                   <tbody>
                                      ...
                                      <tr>
                                         <td class="res-center" style="text-align: center; color: #405060; font-family: 'Raleway', Arial, Sans-serif; font-size: 22px; letter-spacing: 0.7px; word-break: break-word" data-color="M16 Title 1" data-size="M16 Title 1" data-max="32" data-min="12">
                                            Wisata cepat dan mudah dengan GoTripJava
                                         </td>
                                      </tr>
                                      <!-- title end -->
                                      <tr>
                             ...
                             <td>
                                <table width="600" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                                   <tbody>
                                      ...
                                      <tr>
                                          <td class="res-center" style="text-align: center;">
                                             <a href="https://GoTripJava.paling.kencang.id" style="color: #00bb9d; font-family: 'Nunito', Arial, Sans-serif; font-size: 16px; letter-spacing: 0.7px; text-decoration: none; word-break: break-word;" data-color="M2 Link 1" data-size="M2 Link 1" data-max="26" data-min="6">
                                                https://GoTripJava.paling.kencang.id/
                                             </a>
                                          </td>
                                      </tr>
                                      <!-- paragraph end -->
                                      ...
                                      <tr>
                                         <td class="res-center" style="text-align: center; color: #607080; font-family: 'Nunito', Arial, Sans-serif; font-size: 16px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M19 Paragraph 3" data-size="M19 Paragraph 3" data-max="26" data-min="6">
                                            GoTripJava adalah aplikasi yang memudahkan anda dalam mencari tempat wisata di Indonesia, dengan GoTripJava anda dapat menemukan tempat wisata yang anda inginkan dengan cepat dan mudah.
                                         </td>
                                      </tr>
                                      <!-- paragraph end -->
                                      <tr>
           ...
           <tbody>
                                                                                                     ...
                                                                                                     <td>
                                                                                                        <table align="center" border="0" cellpadding="0" cellspacing="0">
                                                                                                           <tbody>
                                                                                                              <tr>
                                                                                                                 <td>
                                                                                                                    <img width="16" style="max-width: 16px; width: 100%; display: block; line-height: 0px; font-size: 0px; border: 0px;" src="http://www.stampready.net/dashboard/editor/user_uploads/zip_uploads/2020/03/22/9jhlVUzudcB8NtbnMg67SvA5/StampReady/img/module19-img02.png">
                                                                                                                 </td>
                                                                                                              </tr>
                                                                                                           </tbody>
                                                                                                        </table>
                                                                                                  ...
                                                                                                  <tr>
                                                                                                     <td class="res-left" style="text-align: left;">
                                                                                                        <a href="https://example.com" style="color: #607080; font-family: 'Nunito', Arial, Sans-serif; font-size: 16px; letter-spacing: 0.7px; text-decoration: none; word-break: break-word;" data-color="M20 Link 3" data-size="M20 Link 3" data-max="26" data-min="6">
                                                                                                         Jl. xxxxxx, Surakarta, Jawa Tengah
                                                                                                        </a>
                                                                                                     </td>
                                                                                                  </tr>
                                                                                                  <!-- link end -->
                                                           ...
                                                           <tbody>
                                                              ...
                                                              <tr>
                                                                 <td class="res-center" style="text-align: right; color: #607080; font-family: 'Nunito', Arial, Sans-serif; font-size: 16px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M20 Paragraph 1" data-size="M20 Paragraph 1" data-max="26" data-min="6">
                                                                    All Rights Reserved © GoTripJava
                                                                 </td>
                                                              </tr>
                                                              <!-- paragraph end -->
                                                              <tr>
              ...
              <tr>
                 <td class="res-center" style="text-align: center; color: #607080; font-family: 'Nunito', Arial, Sans-serif; font-size: 16px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M20 Paragraph 2" data-size="M20 Paragraph 2" data-max="26" data-min="6">
                    E-mail ini dikirim secara otomatis oleh sistem, mohon tidak mengirimkan balasan ke e-mail ini.
                 </td>
              </tr>
              <!-- paragraph end -->
              {{-- <tr>
