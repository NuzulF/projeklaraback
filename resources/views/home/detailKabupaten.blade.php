...
<body>
    ...
    <section class="detailHead section_padding pt-5 pb-5 h-100">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-lg-4 text-center">
                    <img src="{{ asset('images/'.($kabupaten->profilKabupaten->foto_kabupaten ?? 'kabupaten_default.jpg'))  }}" width="500" class="img-fluid"
                        alt="" />
                </div>
    ...
    <section id="destinasiKab" class="destinasiKab sections-bg pb-5">
        <div class="container" data-aos="fade-up">
            <div class="row gy-4" data-aos="fade-up" data-aos-delay="100">
                @forelse($desa as $des)
                        <div class="col-xl-4 col-md-6 destinasiKab-item">
                            <a href="{{ url('desa/' . $des['id']) }}">
                               <div class="destinasiKab-wrap">
                                    <img src="{{ asset('images/'.$des->profilDesa->foto_desa ?? 'kabupaten_default.jpg')  }}"
                                        class="img-fluid" alt="" />
                                    <div class="destinasiKab-info">
                                        <h4>{{ $des->name }}</h4>
                                        <p>{{ $des->profilDesa->alamat_desa }}</p>
                                    </div>
                                </div>
                            </a>
                        </div>
