...
<body>
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
                            ...
                            <div class="collapse navbar-collapse main-menu-item justify-content-center"
                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link is-active" href="{{ url('destinasi') }}">Destinasi</a>
                                    </li>
                                </ul>
                            </div>
    ...
    <section id="pesanTiket" class="blog bayarTiket">
        <div class="container" data-aos="fade-up">
            <div class="lanjutBayar">
                    <h4>Checkout</h4>
                    <div class="row">
                        <p class="col-sm-3">Nama Pemesanan</p>
                        <p> : {{ $transaksi['nama_pemesan'] }}</p>
                    </div>
                    <div class="row">
                        <p class="col-sm-3">Email</p>
                        <p> : {{ $transaksi['email_pemesan'] }}</p>
                    </div>
                    <div class="row">
                        <p class="col-sm-3">No Telp Pemesan</p>
                        <p> : {{ $transaksi['no_telp_pemesan'] }}</p>
                    </div>
                    <div class="row">
                        <p class="col-sm-3">Total Harga</p>
                        <p> : Rp.{{ $transaksi['total_pembayaran'] }}</p>
                    </div>
                    <div class="row">
                        <p class="col-12">Detail item :</p>
                        <p class="col-12">
                            @foreach ($transaksi['keranjang'] as $keranjang)
                               <div class="row col-12">
                                    <div class="col-sm-6">
                                        <p>{{ $keranjang['tipe'] }} ({{ $keranjang['jumlah'] }})</p>
                                    </div>
                                    <div class="col-sm-6">
                                        <p>Rp.{{ $keranjang['total'] }}</p>
                                    </div>
                               </div>
                            @endforeach
                        </p>
                    ...
                    payButton.addEventListener('click', function() {
                        ...
                        window.snap.pay('{{ $snapToken }}', {
                            onSuccess: function(result) {
                                ...
                                window.location.href = "/invoice/tiket/{{ $transaksi['order_id'] }}";
                                console.log(result);
                            },
    ...
    <script>
        ...
        window.history.replaceState({}, document.title, "/keranjang/checkout");
    </script>
