            ...
            <div class="row w-100 m-auto justify-content-around">
                <div class="col-12 col-md-7 container p-0 m-2" data-aos="fade-up">
                    <div class="inputTiket" style="width:auto;">
                        <h4>Pesan Tiket Untuk {{ $paket->nama_paket }}</h4>
                    ...
                    <div class="inputTiket" style="width:auto;">
                        ...
                        <div class="row g-3 m-0">
                            ...
                            <div class="col-12">
                                ...
                                <input type="date" class="form-control mb-3" id="tanggal" value="{{ old('tanggal') }}" name="tanggal" required />
                            </div>
                            <div class="col-md-12">
                            ...
                            @guest
                                <input type="submit" name="aksi"  class="btn col-11 mr-auto ml-auto mt-5 h-25" style="background-color:#092742;color:#ffff" id="buttonLogin" value="Pesan">
                            @else
                            <input type="submit" name="aksi"  class="btn col-5 mr-auto ml-auto mt-5 h-25" style="background-color:#092742;color:#ffff" id="buttonLogin" value="Pesan">
                            <input type="submit" name="aksi"  class="btn col-5 mr-auto ml-auto mt-5 h-25" style="background-color:#092742;color:#ffff" id="buttonLogin" value="Keranjang">
                            @endguest
                        </div>
                    </div>
                </div>
