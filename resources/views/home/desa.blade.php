...
<body>
            ...
            <div class="row">
                <div class="col-xl-12 text-center text-md-left">
                    <div class="section_tittle">
                        <h2>Desa Wisata</h2>
                        <p class="text-justify">Temukan berbagai Destinasi Wisata menarik yang terdapat di berbagai desa wisata.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="desa" class="desa">
        <div class="container" data-aos="fade-up">
            <div class="row gy-4" data-aos="fade-up" data-aos-delay="100">
                @forelse ($desa as $d)
                    <div class="col-lg-4 col-md-6" style="margin-bottom: 20px;">
                        <a href="{{ url('desa/' . $d->id) }}">
                            <div class="listDesa position-relative">
                                <div class="icon">
                                    <i class="fas fa-map-signs"></i>
                                </div>
                                <h3>{{ $d->name }}</h3>
                                <p>
                                    {!! Str::limit(optional($d->profilDesa())->deskripsi_desa ?? 'Tidak ada deskripsi', 130, '...') !!}
                                </p>
                            </div>
                        </a>
                    </div>
